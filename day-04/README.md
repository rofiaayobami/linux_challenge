...
# Day 04 - Revision and Consolidation (Day 1–3)
...
- I reinforced my understanding of basic Linux navigation commands like `pwd`, `ls`, and `cd`
- I improved my knowledge of file permissions and how to modify them using `chmod`
...
- Created directories and files for practice
- Navigated between folders using `cd`
- Modified file permissions and verified them with `ls -l`
...
- Occasionally forgot some command syntax and needed to retry
...
- Consistent practice helps in mastering Linux commands
- Understanding how commands work is more important than memorizing them
